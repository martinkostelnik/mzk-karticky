...
class EmbeddingWrapper(nn.Module):
    ...
    Args:
        bert_embeddings (RobertaEmbeddings): an instance of RobertaEmbeddings
        base (int): `base` parameter of LayoutEmbeddings
    """

    def __init__(self, bert_embeddings, base: int = 500) -> None:
        super().__init__()
        embedding_dim = bert_embeddings.word_embeddings.embedding_dim
        steps = embedding_dim // 8
        self.bert_embs = bert_embeddings
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None,
        ...
        """
        embs = self.bert_embs(input_ids, token_type_ids, position_ids, inputs_embeds, past_key_values_length)
